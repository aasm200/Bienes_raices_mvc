        ...
        <form  data-cy="formulario-contacto"class="formulario" action="/contacto" method="POST">
            ...
            <fieldset>
                ...
                <div class="forma-contacto">
                    ...
                    <input  data-cy="input-forma" type="radio" value="telefono" id="contactar-telefono" name="contacto[contacto]" required>

                    <label for="contactar-email">E-mail</label>
                    <input data-cy="input-forma" type="radio" value="email" id="contactar-email" name="contacto[contacto]" required>
                </div>
            ...
            <input data-cy="input-submit" type="submit" value="Enviar" class="boton-verde">
        </form>
    </main>